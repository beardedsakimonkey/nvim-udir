...
vim.cmd 'hi default link UdirTree       NonText'
vim.cmd 'hi default link UdirVirtText   NonText'
...
vim.cmd 'hi default link UdirPromptCompletion NonText'
vim.cmd 'hi default link UdirDeletePath NonText'
vim.cmd 'hi default link UdirDeleteMore NonText'
